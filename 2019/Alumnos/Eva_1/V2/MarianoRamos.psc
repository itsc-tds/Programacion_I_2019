...
//"IMPORTANTE LEER ANTES DE PROBARLO"
//
//-PONER EN LENGUAJE "FLEXIBLE" Y EJECUTARLO NORMALMENTE
...
//						definir Cali1 como caracter; 
					...
					Segun ConvertirANumero(cali1) Hacer
						1:
							n<- "2D";
							calidad2d <-CONCATENAR(memo + " En Calidad " , n);
							Escribir calidad2d; 
...
//									cali1<-3;
						...
						2:
							m<- "3D";
							calidad3d <-CONCATENAR(memo + " En Calidad " , m);
							Escribir calidad3d; 
